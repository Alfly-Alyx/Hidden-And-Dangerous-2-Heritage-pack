...
Le paquet remplace uniquement les deux numéros croisés pour `AF2_02` et `AF2_05`. Les sept lignes officielles d'`AF2_03`, ses gestionnaires 1, 5 et 20, sa ronde `AF2_03_01` à `AF2_03_06` et son trajet `AF2_03_alert` subsistent, mais l'acteur `AF2_03` est absent d'`actors.bin` et du registre de scripts de la mission : la liste commerciale passe directement de `AF2_02` à `AF2_04`. Ces raccordements restent donc commentés jusqu'à la reconstruction explicite de l'acteur ; les activer seuls produirait une liaison orpheline.
