...
- deux gardes d'Africa 2 rejoignent de nouveau la réaction coordonnée de leur groupe : `AF2_02` reçoit son signal d'alerte 20 et `AF2_05` son signal d'alerte 5 ; `AF2_03` conserve ses sept lignes commentées, ses gestionnaires, sa ronde et ses points, mais son acteur manque dans `actors.bin` et dans le registre de mission, ce qui réserve sa remise en jeu à la reconstruction finale ; le détecteur rapproché coupé des gardes 14–15 est rétabli avec son arrêt en cas d'alarme, le signal 10 d'`AF2_14` et les trois déplacements d'`AF2_15` ; le garde 14 récupère son filtre 512 cohérent avec tout le groupe et le premier renfort sa mise à couvert symétrique aux trois autres ;
