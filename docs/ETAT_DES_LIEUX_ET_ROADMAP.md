...
- audit manuel complet d'Arctic 1 à Arctic 4, de Czech 1 à Czech 6, de Normandy 1 à Normandy 2, de Norway, Sicily 1–2, Burgundy 1–3, Libye 1–3 et Africa 1–3 : les restaurations démontrables sont intégrées aux sources, tandis que les branches incomplètes, remplacées ou réellement manquantes restent isolées ;
