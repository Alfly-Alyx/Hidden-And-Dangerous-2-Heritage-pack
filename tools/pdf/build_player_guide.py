...
def build_player():
    ...
    s = []
    cover(s, "Guide joueur - Edition 0.8.0", "Secrets et<br/>easter eggs",
          "Sept séquences cachées, leurs conditions et les coins secrets utiles pour les atteindre.",
          "Hidden &amp; Dangerous 2: Sabre Squadron 1.12<br/>Guide pratique en français - 20 septembre 2026")
    ...
    s.append(info_box("Pack conseillé",
        "Installez H&amp;D2 Heritage Pack 0.8.0 et laissez cochée l'option des easter eggs. "
    ...
    s.append(info_box("Attention avec la version 1.12",
        ...
        "mais cette route historique peut rester inaccessible. Le Heritage Pack 0.8.0 ne déplace pas encore le lingot afin de ne pas inventer une nouvelle cachette.",
