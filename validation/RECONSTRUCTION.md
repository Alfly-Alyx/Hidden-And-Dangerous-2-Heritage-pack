...
Au 26 septembre 2026 : **50 profils, 304 contrôles, tous pending**. Aucun essai
moteur n'a été effectué par la création du registre ou son audit.

- 44 variantes de scripts solo et deux Carnage : six contrôles chacune;
...
Une seule paire emploie un témoin composé : transition Africa 4 avec la
conséquence radio Heritage. Son identité `heritage-africa4-radio-v1` est requise
dans le protocole et dans les configurations natives. Les autres témoins restent
commerciaux. Cette comparaison ne qualifie pas l'ensemble du pack Heritage.
...
Elle réussit avec 304 cas pending, sans annoncer une validation moteur.
...
chacun des 50 profils. Les fiches réunissent :
...
des 304 essais moteur, qui restent en attente.
