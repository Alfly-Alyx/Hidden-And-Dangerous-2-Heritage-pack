...
| [LIBYE2_DIALOGUE_24_25_CONDITIONAL_53990023](../LIBYE2_DIALOGUE_24_25_CONDITIONAL_53990023/ETUDE.md) | Documenté / contrat à tester | WAV 5,507 s et synchronisation présents. Huit véhicules à zéro, Jeep1 exclue; vérification au moment de la phrase, anti-rejeu et interruptions nécessaires. Aucun objectif supplémentaire. |
...
| [AFRICA4_INVASION_TRANSITION_VARIANT](../AFRICA4_INVASION_TRANSITION_VARIANT/ETUDE.md) | Prototype désactivé / composition à valider | Fragment historique du fondu et de la pause initiale 20 s. Baselines commerciale/Heritage distinctes; conserver la restauration radio et les attentes actives. Aucun export complet compatible Heritage revendiqué. |
