...
| Flammenwerfer 35 / No.2 | Enregistrement allemand officiel; vestige britannique remplacé par Flak TMP; munitions, icônes et effet 25/flame1. Deux [ensembles extérieurs modernes](../FLAMMENWERFER_35_AND_NO2/MODELES_MODERNES.md) réalisés, 21/19 pièces, sac et tuyau statiques. | FPV, rattachements, animations, mapping de tir et son à construire ; validation moteur nécessaire. IDs additifs à qualifier ; ne jamais réutiliser Flak TMP. |
| FG42 | Enregistrement `item_shoot` officiel mais ancien emplacement 27 réutilisé par un casque. [Extérieur original moderne](../FG42/MODELE_MODERNE.md) fabriqué, 25 pièces et deux LOD. | FPV, animations et entrée additive à construire ; extérieur et tenue à tester en moteur. Conserver la provenance de la munition. |
| MG34 portable | Enregistrement officiel mais ancien emplacement 32 réutilisé; munition portable distincte de la munition 211 du montage. [Extérieur original moderne](../MG34_PORTABLE/MODELE_MODERNE.md) fabriqué, 33 pièces et deux LOD. | FPV, animations et entrée additive à construire ; extérieur à tester. Ne pas confondre portable et montage de char. |
