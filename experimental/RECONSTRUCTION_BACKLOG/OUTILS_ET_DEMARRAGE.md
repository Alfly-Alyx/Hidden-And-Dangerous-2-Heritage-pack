...
| `tools/reconstruction_runtime_audit.py` | Vérifier séparément les 50 profils expérimentaux, leurs 304 contrôles et leurs preuves de mode solo/Carnage/coop; aucun lancement moteur. |
